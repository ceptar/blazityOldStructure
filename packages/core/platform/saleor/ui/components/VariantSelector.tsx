...
import { type ProductListItemFragment, type VariantDetailsFragment } from "@enterprise-commerce/core/platform/saleor/codegen/graphqlommerce/core/platform/saleor/codegen/graphql"
          ...
          {variants.map((variant) => {
            ...
            return (
              <LinkWithChannel
                ...
                prefetch={true}
                scroll={false}
                href={isDisabled ? "#" : getHrefForVariant({ productSlug: product.slug, variantId: variant.id })}
                className={clsx(
                  isCurrentVariant ? "border-transparent bg-neutral-900 text-white hover:bg-neutral-800" : "border-neutral-200 bg-white text-neutral-900 hover:bg-neutral-100",
