...
} from "@enterprise-commerce/core/platform/saleor/checkout/lib/globalTypes";
import { type FormDataBase } from "@enterprise-commerce/core/platform/saleor/checkout/hooks/useForm";
...
>() => {
  ...
  const getParsedApiError = useCallback(
    ({
      code,
      field,
    }: ApiError<TFormData, TErrorCodes>): ParsedApiError<TFormData> => {
