...
import {
  EyeHiddenIcon,
  EyeIcon,
} from "@enterprise-commerce/core/platform/saleor/checkout/ui-kit/icons";
import { IconButton } from "@enterprise-commerce/core/platform/saleor/checkout/components/IconButton";

export interface PasswordInputProps<TName extends string>
...
export const PasswordInput = <TName extends string>(
  props: PasswordInputProps<TName>
