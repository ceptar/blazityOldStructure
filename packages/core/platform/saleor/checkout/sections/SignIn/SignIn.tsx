...
import { PasswordInput } from "@enterprise-commerce/core/platform/saleor/checkout/components/PasswordInput";
import { TextInput } from "@enterprise-commerce/core/platform/saleor/checkout/components/TextInput";
import { useSignInForm } from "@enterprise-commerce/core/platform/saleor/checkout/sections/SignIn/useSignInForm";
import { usePasswordResetRequest } from "@enterprise-commerce/core/platform/saleor/checkout/sections/SignIn/usePasswordResetRequest";
...
} from "@enterprise-commerce/core/platform/saleor/checkout/sections/Contact/SignInFormContainer";
import { isValidEmail } from "@enterprise-commerce/core/platform/saleor/checkout/lib/utils/common";
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="flex w-full flex-row items-center justify-end">
            <Button
              ...
              className="ml-1 mr-4"
              onClick={(e) =>
                isSubmitting ? e.preventDefault() : onPasswordResetRequest
              }
            />
            <Button
              type="submit"
