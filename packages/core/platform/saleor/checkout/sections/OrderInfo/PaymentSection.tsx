...
import { useOrder } from "@enterprise-commerce/core/platform/saleor/checkout/hooks/useOrder";
import { usePaymentStatus } from "@enterprise-commerce/core/platform/saleor/checkout/sections/PaymentSection/utils";
      ...
      <div data-testid="paymentStatus">
        <div className="flex flex-row items-center">
          ...
          {paymentStatus === "paidInFull" && (
            <SuccessMessage message="We've received your payment" />
          )}
