...
import { type CheckoutLineFragment } from "@enterprise-commerce/core/platform/saleor/checkout/graphql";
import { TextInput } from "@enterprise-commerce/core/platform/saleor/checkout/components/TextInput";

import { Skeleton } from "@enterprise-commerce/core/platform/saleor/checkout/components";
...
import { useSummaryItemForm } from "@enterprise-commerce/core/platform/saleor/checkout/sections/Summary/useSummaryItemForm";
...
export const SummaryItemMoneyEditableSection: React.FC<
  SummaryItemMoneyEditableSectionProps
> = ({ line }) => {
