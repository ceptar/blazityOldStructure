...
//       const fetchedCategories = data.categories.edges.map((edge: any) => ({
//         text: edge.node.name,
//         href: `/category/${edge.node.id}`,
//         submenu: null,
//       }));
...
//   const itemsMarkup = categories.map((singleMenuItem) => (
//     <li
...
//         <VariantGrid
//           items={singleMenuItem.submenu?.items}
//           variant={singleMenuItem.submenu?.variant}
//         />
//         <div className="submenu__inner flex w-full flex-col gap-4 md:hidden">
//           <a href={singleMenuItem.href || "#"}>
//             <h4 className="mb-20 text-center text-xl underline">
//               See all {singleMenuItem.text}
//             </h4>
//           </a>
//         </div>
//       </div>
...
//                 <button
//                   className="menu-close-button absolute right-3 top-0 bg-transparent md:hidden"
